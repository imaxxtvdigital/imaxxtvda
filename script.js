...
function processMessage(message) {
  ...
  if (
    ...
    addBotMessage(subscriptionResponse, [
      "Sign up now",
  ...
  if (
    ...
    lowerMessage.match(/^(hi|hello|hey)$/)
  ) {
  ...
  addBotMessage(
    "I'm not sure I understand. Could you please rephrase or select one of these common topics?",
    [
      "Subscription plans",
      "Watch on devices",
      "Content library",
...
function updateContext(message) {
  ...
  if (!chatContext.userName) {
    const nameMatch =
      lowerMessage.match(/my name is ([a-z]+)/i) ||
